module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('messages', 'to_userId', {
        transaction,
      });

      await queryInterface.removeColumn('messages', 'chat_roomId', {
        transaction,
      });

      await queryInterface.removeColumn('messages', 'from_userId', {
        transaction,
      });
